...
function func2(event){
    if(!event.currentTarget.className.includes('selected-seat')) event.currentTarget.classList.add('selected-seat');
    else event.currentTarget.classList.remove('selected-seat');
    if(document.getElementsByClassName('selected-seat').length>0) document.getElementById('book-ticket-btn').className='';
